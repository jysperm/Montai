...
DaVinci Resolve only reliably imports Cross Dissolve (fade) from FCPXML — Slide and Wipe transitions fall back to dissolve. Overlay animations and audio fadeIn/fadeOut are also ignored by DaVinci.
